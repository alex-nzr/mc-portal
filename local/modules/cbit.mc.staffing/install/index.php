...
use Cbit\Mc\Staffing\Agent\AgentManager;
use Cbit\Mc\Staffing\Internals\Control\EventManager as CbitEventManager;
use Cbit\Mc\Staffing\Internals\Installation\DBTableInstaller;
use Cbit\Mc\Staffing\Internals\Installation\Installer;


Loc::loadMessages(__FILE__);

class cbit_mc_staffing extends CModule
{
    private CMain $App;
