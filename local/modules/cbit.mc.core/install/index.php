...
use Cbit\Mc\Core\Internals\Control\EventManager as CbitEventManager;
use Cbit\Mc\Core\Internals\Installation\Installer;


Loc::loadMessages(__FILE__);

class cbit_mc_core extends CModule
{
    private CMain $App;
    ...
    public function InstallFiles()
    {
        ...
        //directory for logs
        if (!is_dir($this->docRoot . '/local/logs'))
        {
            mkdir($this->docRoot . '/local/logs', 0777, true);
        }
    }
