...
use Cbit\Mc\Zup\Agent\AgentManager;
use Cbit\Mc\Zup\Internals\Control\EventManager as CbitEventManager;
...
class cbit_mc_zup extends CModule
{
    private CMain $App;
