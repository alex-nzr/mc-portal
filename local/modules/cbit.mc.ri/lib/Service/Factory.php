...
use Cbit\Mc\RI\Service\Operation\Action\AfterAdd;
use Cbit\Mc\RI\Service\Operation\Action\AfterUpdate;
use Cbit\Mc\RI\Service\Operation\Action\BeforeAdd;
use Cbit\Mc\RI\Service\Operation\Action\BeforeUpdate;
use Cbit\Mc\RI\Service\Operation\Action\BeforeDeletion;
...
class Factory extends Dynamic
{
    ...
    public function getAddOperation(Item $item, Context $context = null): Operation\Add
    {
        return parent::getAddOperation($item, $context)
            ...
            ->addAction( Operation::ACTION_AFTER_SAVE , new AfterAdd() );
    }
