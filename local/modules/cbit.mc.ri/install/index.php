...
use Cbit\Mc\RI\Agent\AgentManager;
use Cbit\Mc\RI\Internals\Control\EventManager as CbitEventManager;
use Cbit\Mc\RI\Internals\Installation\Installer;


Loc::loadMessages(__FILE__);

class cbit_mc_ri extends CModule
{
    private CMain $App;
