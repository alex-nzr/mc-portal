 ...
 * ==================================================
 */
namespace Cbit\Mc\Partner\Internals\EditorConfig;

use Cbit\Mc\Partner\Internals\EditorConfig\Scheme\CommonConfig;
use Exception;
use Cbit\Mc\Core\Internals\Contract\IEditorConfig;

/**
 * @class Factory
 * @package Cbit\Mc\Partner\Internals\EditorConfig
 */
class Factory
{
     ...
     * @param int $typeId
     * @param int $entityTypeId
     * @return \Cbit\Mc\Partner\Internals\EditorConfig\Factory|null
     */
