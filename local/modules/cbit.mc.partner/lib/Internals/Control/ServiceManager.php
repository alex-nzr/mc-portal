...
use Cbit\Mc\Partner\Controller;
use Cbit\Mc\Partner\Entity;
use Cbit\Mc\Partner\Filter\FilterFactory;
use Cbit\Mc\Partner\Service\Container;
use Cbit\Mc\Partner\Service\Integration\Intranet\CustomSectionProvider;
use Cbit\Mc\Partner\Service\Router;
use Exception;
...
class ServiceManager
{
    ...
    /**
     * @return \Cbit\Mc\Partner\Internals\Control\ServiceManager
     */
