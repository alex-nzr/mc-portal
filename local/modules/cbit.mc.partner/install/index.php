...
use Cbit\Mc\Partner\Agent\AgentManager;
use Cbit\Mc\Partner\Internals\Control\EventManager as CbitEventManager;
use Cbit\Mc\Partner\Internals\Installation\Installer;


Loc::loadMessages(__FILE__);

class cbit_mc_partner extends CModule
{
    private CMain $App;
