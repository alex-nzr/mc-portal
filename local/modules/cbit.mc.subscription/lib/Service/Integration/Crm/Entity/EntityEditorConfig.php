...
namespace Cbit\Mc\Subscription\Service\Integration\Crm\Entity;
 ...
 * @package Cbit\Mc\Subscription\Service\Integration\Crm\Entity
 */
        ...
        try
        {
            ...
            foreach ($categories as $category)
            {
                ...
                if ($editorConfig instanceof IEditorConfig)
                {
                    ...
                    {
                        $result->addError(new Error("Can not find card configuration for category ".$category->getName()));
                    }
                }
                else
                {
