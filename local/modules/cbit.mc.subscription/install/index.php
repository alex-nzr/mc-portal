...
use Cbit\Mc\Subscription\Agent\AgentManager;
use Cbit\Mc\Subscription\Internals\Control\EventManager as CbitEventManager;
use Cbit\Mc\Subscription\Internals\Installation\Installer;


Loc::loadMessages(__FILE__);

class cbit_mc_subscription extends CModule
{
    private CMain $App;
