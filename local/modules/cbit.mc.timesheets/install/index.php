...
use Cbit\Mc\Timesheets\Agent\AgentManager;
use Cbit\Mc\Timesheets\Internals\Control\EventManager as CbitEventManager;
use Cbit\Mc\Timesheets\Internals\Installation\Installer;

Loc::loadMessages(__FILE__);

/**
 * Class cbit_mc_timesheets
 */
class cbit_mc_timesheets extends CModule
{
    private CMain $App;
