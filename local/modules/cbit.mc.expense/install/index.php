...
use Cbit\Mc\Expense\Agent\AgentManager;
use Cbit\Mc\Expense\Internals\Control\EventManager as CbitEventManager;
use Cbit\Mc\Expense\Internals\Installation\Installer;


Loc::loadMessages(__FILE__);

class cbit_mc_expense extends CModule
{
    private CMain $App;
