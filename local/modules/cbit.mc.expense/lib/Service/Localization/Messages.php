...
namespace Cbit\Mc\Expense\Service\Localization;
...
/**
 * @class Messages
 * @package Cbit\Mc\Expense\Service\Localization
 */
class Messages extends Localization
{
    ...
    {
        //\Cbit\Mc\Expense\Internals\Debug\Logger::print(parent::loadMessages());
