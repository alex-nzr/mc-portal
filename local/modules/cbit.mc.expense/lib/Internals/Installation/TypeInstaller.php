...
class TypeInstaller
{
    ...
    /**
     * @param \Bitrix\Main\ORM\Objectify\EntityObject | \Bitrix\Crm\Model\Dynamic\Type $type
     * @param array $fields
     * @param bool $isUpdate
     * @return \Bitrix\Main\ORM\Data\AddResult|\Bitrix\Main\ORM\Data\UpdateResult
     * @throws \Exception
     */
    protected static function setTypeData(EntityObject|Type $type, array $fields, bool $isUpdate = false): UpdateResult|AddResult
    {
    ...
    protected static function getFields($title, $name, $code, $entityTypeId, $customSectionId): array
    {
        return [
            ...
            "IS_LINK_WITH_PRODUCTS_ENABLED" => true,
