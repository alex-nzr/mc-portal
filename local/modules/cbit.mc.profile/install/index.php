...
use Cbit\Mc\Profile\Internals\Installation\Installer;
use Cbit\Mc\Profile\Internals\Model\Approval\PhotoQueueTable;
use Cbit\Mc\Profile\Agent\AgentManager;
use Cbit\Mc\Profile\Helper\Intranet\LeftMenu;
use Cbit\Mc\Profile\Internals\Control\EventManager as CbitEventManager;
...
class cbit_mc_profile extends CModule
{
    private CMain $App;
    ...
    public function __construct()
    {
        ...
        $this->dataClasses = [
            PhotoQueueTable::class,
            UserPhotoTable::class
        ];
    }
    ...
    public function InstallDB()
    {
        ...
        if ($result->isSuccess())
        {
            ...
            (new UserProfile\Form())->resetEditorConfiguration();
            DataFiller::getInstance()->setUploadedDocsLinkForAll();
    ...
    {
        copy($_SERVER['DOCUMENT_ROOT'] . "/.top.menu_ext.php", $_SERVER['DOCUMENT_ROOT'] . "/.top.menu_ext.php.bak");
    ...
    public function UnInstallFiles()
    {
        ...
        copy($_SERVER['DOCUMENT_ROOT'] . "/.top.menu_ext.php.bak", $_SERVER['DOCUMENT_ROOT'] . "/.top.menu_ext.php");
    }
     ...
     * @throws \Exception
     */
    private function deleteDataTables()
    {
        $connection = Application::getConnection();
