...
use Cbit\Mc\Core\Service\Integration\Zup;
use Cbit\Mc\Zup\Service\Integration\Intranet\UserCMLImport;

Loader::includeModule('cbit.mc.zup');
...
$arParams['UPDATE_PROPERTIES'][] = 'XML_ID';
$arParams['UPDATE_PROPERTIES'][] = 'NAME';
$arParams['UPDATE_PROPERTIES'][] = 'LAST_NAME';
$arParams['UPDATE_PROPERTIES'][] = 'SECOND_NAME';

//UPDATE CUSTOM FIELDS///////////////////////////////////////////

$arParams['UPDATE_PROPERTIES'] = array_unique(
    array_merge( $arParams['UPDATE_PROPERTIES'], Zup\Fields::getFieldCodes() )
);
